...
// update the contributionsCard with the formatted value
...
// update the raisedCard with the formatted value
...
function filterUnfundedOnly() {
    ...
    // Optional: Log the array length for debugging
...
const unfundedText = `A total of $800,268 have been raised for 11 games. Currently, ${unfundedGames} unfunded game${unfundedGames === 1 ? "" : "s"} on our platform. We need your help to fund these amazing games!`;


// create a new DOM element containing the template string and append it to the description container
const unfundedParagraph = document.createElement("p");
unfundedParagraph.innerText = unfundedText;
